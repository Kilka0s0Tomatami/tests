...
Create User With Existing Username
    ...
    ...    role_id=1
    ${response} =    POST    ${BASE_URL}/administration    json=${body}    headers=${headers}
    RETURN    ${response}
...
Delete Nonexistent User
    ${headers} =    Create Dictionary    Content-Type=application/json
    ${response} =    DELETE    ${BASE_URL}/administration/9999999    headers=${headers}
    RETURN    ${response}
...
Update User Role To Invalid
    ...
    ...    user_id=999
    ...    role_id=99999
    ${response} =    PUT    ${BASE_URL}/administration    json=${body}    headers=${headers}
    RETURN    ${response}
